...
# bin/lib/smoke/checkout.sh — checkout create / get / update / complete, secured order
# read, and signed webhook capture. Sourced by ci-smoke.sh; uses resolved_* from catalog
# and smoke_email / sales_channel_id / WEBHOOK_CAPTURE_URL from the orchestrator.
