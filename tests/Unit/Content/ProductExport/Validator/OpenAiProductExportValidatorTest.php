...
class OpenAiProductExportValidatorTest extends TestCase
{
    ...
    {
        $entity = $this->createProductExportEntity('google');
        $errors = new ErrorCollection();

        $this->createValidator()->validate($entity, 'not-jsonl', $errors);
    ...
    public function testValidateAddsJsonlValidationErrorForMalformedJsonl(): void
    {
        ...
        $this->createValidator()->validate($entity, "{\"item_id\": }\n", $errors);
    ...
    public function testValidateDoesNotAddErrorsForValidOpenAiFeed(): void
    {
        ...
        $content = $this->createValidRow().\PHP_EOL;
    ...
    private function createProductExportEntity(?string $provider = 'open-ai'): ProductExportEntity
    {
    ...
    private function createValidator(): OpenAiProductExportValidator
    {
        return new OpenAiProductExportValidator(new JsonlRowParser());
    }
