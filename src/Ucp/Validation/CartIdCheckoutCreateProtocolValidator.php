 ...
 * payload the operation maps from is untouched. Scoped to the pinned `2026-04-08` schema
 * and intended as a stopgap: remove it once the REST `checkout.create` schema treats
 * `line_items` as optional when `cart_id` is supplied.
 *
 * @internal
 */
